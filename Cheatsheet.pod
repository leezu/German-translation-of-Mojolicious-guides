...
Ändere Raw-Bytes in eine Antwort.
...
Maximale Zeilengröße von Startzeilen und Header von HTTP-Nachrichten in Bytes.
...
Maximale Größe für HTTP-Content, der im Speicher gehalten wird.
